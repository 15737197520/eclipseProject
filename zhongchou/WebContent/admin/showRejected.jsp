...
</tr>                                                 <!-- 这个页面能不能接收checkGoods之类的？ -->
<s:if test="showRejected==null">
			<tr>
...
<s:iterator value="showRejected" id="goods">
<tr align="center">
  ...
  <td  bgcolor="#ffffff"><a href="RcheckPass?checkId=${goodsId}">通过</a></td>
  <td  bgcolor="#ffffff"><a href="deleteGoods?checkId=${goodsId}" >删除</a></td>
</tr>
</s:iterator>
