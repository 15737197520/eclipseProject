...
<s:iterator value="checkGoods" id="goods">
<tr align="center">
  ...
  <td  bgcolor="#ffffff"><a href="checkPass?checkId=${goodsId }">通过</a></td>
  <td  bgcolor="#ffffff"><a href="checkReject?checkId=${goodsId }" >拒绝</a></td>
</tr>
</s:iterator>
